...
/*   Updated: 2018/04/03 22:25:40 by ravard           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		Bureaucrat::signAForm( AForm const & f) const {
	if (f.getSigned())
		std::cout << *this << " vient de signer le " << f << std::endl;
	else
		std::cout << *this << " ne peut signer le " << f << std::endl;
}
